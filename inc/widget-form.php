...
<div class="apw-widget-form">
	...
	<div class="apw-section">
		...
		<div class="apw-section-top" data-fieldset="general">
			<div class="apw-top-action">
				<a class="apw-action-indicator hide-if-no-js" data-fieldset="general" href="#"></a>
			</div>
			<div class="apw-section-title">
				<h4 class="apw-section-heading" data-fieldset="general"><?php _e( 'General Settings' );?></h4>
			</div>
		</div>
	...
	<div class="apw-section">
		...
		<div class="apw-section-top" data-fieldset="filters">
			<div class="apw-top-action">
				<a class="apw-action-indicator hide-if-no-js" data-fieldset="filters" href="#"></a>
			</div>
			<div class="apw-section-title">
				<h4 class="apw-section-heading" data-fieldset="filters"><?php _e( 'Filters' );?></h4>
			</div>
		</div>
	...
	<div class="apw-section">
		...
		<div class="apw-section-top" data-fieldset="thumbnails">
			<div class="apw-top-action">
				<a class="apw-action-indicator hide-if-no-js" data-fieldset="thumbnails" href="#"></a>
			</div>
			<div class="apw-section-title">
				<h4 class="apw-section-heading" data-fieldset="thumbnails"><?php _e( 'Post Thumbnail' );?></h4>
			</div>
		</div>
	...
	<div class="apw-section">
		...
		<div class="apw-section-top" data-fieldset="excerpts">
			<div class="apw-top-action">
				<a class="apw-action-indicator hide-if-no-js" data-fieldset="excerpts" href="#"></a>
			</div>
			<div class="apw-section-title">
				<h4 class="apw-section-heading" data-fieldset="excerpts"><?php _e( 'Post Excerpt' );?></h4>
			</div>
		</div>
	...
	<div class="apw-section">
		...
		<div class="apw-section-top" data-fieldset="format">
			<div class="apw-top-action">
				<a class="apw-action-indicator hide-if-no-js" data-fieldset="format" href="#"></a>
			</div>
			<div class="apw-section-title">
				<h4 class="apw-section-heading" data-fieldset="format"><?php _e( 'Format' );?></h4>
			</div>
		</div>
