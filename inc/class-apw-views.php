 ...
 * @subpackage APW_Views
 *
 * @since 1.0
 */

if( ! class_exists( 'APW_Views' ) ) :
	...
	class APW_Views
	{
		 ...
		 */
		public static function apw_thumbnail_div( $post = 0, $instance = array(), $echo = true )
		{
			$_post = get_post( $post );
			...
			$_html = '';
			$_thumb = APW_Utils::get_apw_post_thumbnail( $_post, $instance );

			$_classes = array();
			$_classes[] = 'post-thumbnail';
			...
			if( '' !== $_thumb ) {
				...
				$_html .= sprintf('<div class="%1$s">%2$s</div>',
					$class_str,
			...
			$html = apply_filters( 'apw_thumbnail_div', $_html, $_post, $instance );
