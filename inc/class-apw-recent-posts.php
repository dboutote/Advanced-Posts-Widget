...
class APW_Recent_Posts
{
	...
	public function set_contstants()
	{
		define( 'APW_PATH', $this->path );
		define( 'APW_INC_PATH', $this->path . trailingslashit('inc') );
		define( 'APW_TPL_PATH', $this->path . trailingslashit('tpl') );
	}
	 ...
	 *
	 * @see APW_Recent_Posts::add_image_sizes()
	 *
	 * @access public
	 *
	 * @since 1.0
	 ...
	 *
	 * @see APW_Recent_Posts::register_image_sizes()
	 *
	 * @access public
	 *
	 * @since 1.0
	...
	public function register_image_sizes()
	{
		...
		$_is_active = is_active_widget( false, false, 'apw-recent-posts', false );
